...
feature 'PanaValidationQuestionary' do
  ...
  scenario 'Create a new questionary having a respondi ticket' do
    PanaValidationQuestionaryStructure::MAPPING.each_key do |group|
      ...
      url = "https://mingle.respondi.com/s/#{PanaValidationQuestionariesController::RESPONDI_RETURN_CODES[group.to_sym]}/ospe.php3?c_0002=1&return_tic=#{subject.tic}" # rubocop:disable Metrics/LineLength
